...
$string['embednottrusted'] = 'この外部動画は、ホスト（{$a}）が信頼できる外部動画ホストの一覧に登録されていないため、埋め込み表示されません。';
$string['embednottrusted_addhost'] = 'サイト管理者は「サイト管理 ▸ プラグイン ▸ 活動モジュール ▸ Video Assessment ▸ 信頼できる外部動画ホスト」で、このホストを許可できます。';
$string['embedopenexternal'] = '動画を新しいタブで開く';
...
$string['score'] = 'スコア';
$string['scores'] = 'スコア';
$string['seecomment'] = '[コメントを見る]';
$string['seereport'] = 'レポートを見る';
$string['seevideo'] = '[動画を見る]';
$string['selectvideoservice'] = '動画サービス';
$string['self'] = '自己';
...
$string['trustedembedhosts'] = '信頼する外部動画ホスト';
$string['trustedembedhosts_help'] = '外部動画リンクは、教師やピアが採点時に読み込む埋め込みプレーヤーに変換されます。YouTube・Vimeo・Dailymotion は常に各社のプレーヤーホスト経由で埋め込まれ安全です。一方、自己ホスト型プラットフォーム(PeerTube・Esup-Pod・Opencast)や他プラットフォームの「埋め込み」リンクは、ユーザーが貼り付けたリンク内のホストをそのまま使うため、このリストでどのホストの埋め込みを許可するかを制御します(学生がフィッシングやクリックジャッキングのページを貼り付けることへの防御策です)。1行に1ホストを入力してください。ホストはサブドメインも対象になります(「univ.fr」と入力すると「media.univ.fr」も信頼されます)。「#」で始まる行はコメントです。所属機関の動画サーバのホストをここに追加してください。リストにないホストへのリンクも機能しますが、埋め込みプレーヤーではなく通常のクリック可能なリンクとして表示されます。';
$string['tryagain'] = '再試行';
...
$string['videoservice_other'] = 'その他(埋め込みリンクを貼り付け)';
$string['videoservice_peertube'] = 'PeerTube(例: Tubes)';
$string['videoservice_vimeo'] = 'Vimeo';
$string['videoservice_youtube'] = 'YouTube';
$string['videoservicehint'] = '次のような動画リンクを貼り付けてください:';
