...
class mod_videoassessment_mod_form extends moodleform_mod {
    ...
    public function manageVideo() {
        ...
        if ($isteacher) {
            ...
            $this->add_link_element('assignpeers', new moodle_url('/mod/videoassessment/view.php', array('id' => $cm->id, 'action' => 'peers')), get_string('assignpeers', 'videoassessment'));
    ...
    public function addNotifications(){
        ...
        $mform->setDefault('isregisteredemail', 1);
...
[[teacher name]]";
        ...
        $mform->setDefault('teachercommentnotification', 1);
...
[[teacher name]]";
        ...
        $mform->setDefault('peercommentnotification', 1);
...
[[teacher name]]";
        ...
        $mform->setDefault('remindernotification', 1);
...
https://moodle.sgu.ac.jp";
        ...
        $mform->setDefault('videonotification', 1);
